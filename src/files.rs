...
impl Files {
  ...
  pub(crate) async fn serve_invoice_qr_code(
    ...
    let payment_request_encdoded =
      percent_encoding::utf8_percent_encode(&payment_request, &Self::ENCODE_CHARACTERS);
    ...
    Ok(
      Response::builder()
        ...
        .body(Body::from(Self::get_svg_string(&qr_code, 4)))
        .expect("All arguments to response builder are valid"),
    )
  }

  fn get_svg_string(qr: &QrCode, border: i32) -> String {
